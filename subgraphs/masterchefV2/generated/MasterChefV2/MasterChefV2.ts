...
export class MasterChefV2__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MasterChefV2__updatePoolResultPoolStruct extends ethereum.Tuple {
  get accSuniPerShare(): BigInt {
...
export class MasterChefV2 extends ethereum.SmartContract {
  ...
  pendingSuwp(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingSuwp",
      "pendingSuwp(uint256,address):(uint256)",
      [
  ...
  try_pendingSuwp(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingSuwp",
      "pendingSuwp(uint256,address):(uint256)",
      [
  ...
  poolInfo(param0: BigInt): MasterChefV2__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new MasterChefV2__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<MasterChefV2__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new MasterChefV2__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  suwp(): Address {
    let result = super.call("suwp", "suwp():(address)", []);

    return result[0].toAddress();
  }

  try_suwp(): ethereum.CallResult<Address> {
    let result = super.tryCall("suwp", "suwp():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  suwpPerBlock(): BigInt {
    let result = super.call("suwpPerBlock", "suwpPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_suwpPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("suwpPerBlock", "suwpPerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  updatePool(_pid: BigInt): MasterChefV2__updatePoolResultPoolStruct {
    let result = super.call(
      "updatePool",
    ...
    return result[0].toTuple() as MasterChefV2__updatePoolResultPoolStruct;
  }

  try_updatePool(
    _pid: BigInt
  ): ethereum.CallResult<MasterChefV2__updatePoolResultPoolStruct> {
    let result = super.tryCall(
      "updatePool",
      "updatePool(uint256):((uint128,uint64,uint64))",
      [ethereum.Value.fromUnsignedBigInt(_pid)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as MasterChefV2__updatePoolResultPoolStruct
    );
  }

  userInfo(param0: BigInt, param1: Address): MasterChefV2__userInfoResult {
    let result = super.call(
      "userInfo",
  ...
  try_userInfo(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MasterChefV2__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
