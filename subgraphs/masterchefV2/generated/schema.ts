...
export class Pool extends Entity {
  ...
  get accSuniPerShare(): BigInt {
    let value = this.get("accSuniPerShare");
    return value.toBigInt();
  }

  set accSuniPerShare(value: BigInt) {
    this.set("accSuniPerShare", Value.fromBigInt(value));
  }

  get segBalance(): BigInt {
    let value = this.get("segBalance");
    return value.toBigInt();
  }

  set segBalance(value: BigInt) {
    this.set("segBalance", Value.fromBigInt(value));
  }
...
export class User extends Entity {
  ...
  get sushiHarvested(): BigInt {
    let value = this.get("sushiHarvested");
    return value.toBigInt();
  }

  set sushiHarvested(value: BigInt) {
    this.set("sushiHarvested", Value.fromBigInt(value));
  }
